    ...
    public function handle(ProductOrdered $event)
    {
        ...
        try {
            ...
            $order_info->update([
                ...
                'payment_status' => $order_info->payment_gateway == "cash_on_delivery" ? $order_info->payment_status : 'complete' ,
                'status' => $order_info->payment_gateway  == "cash_on_delivery" ? $order_info->status : 'complete'
            ]);
