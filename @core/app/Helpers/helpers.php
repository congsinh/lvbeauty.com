...
function render_image_markup_by_attachment_id($id, $class = null, $size = 'full', $description = "")
{
    if (empty($id)) return '';
    $output = '';
    ...
    if (!empty($image_details)) {
        ...
        if($description) $output.= '<div class="gateway-description-mess">'.$description.'</div>';
    }
    return $output;
}
