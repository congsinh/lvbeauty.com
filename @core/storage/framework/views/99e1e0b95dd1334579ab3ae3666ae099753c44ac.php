                    ...
                    <div class="btn-wrapper">
                        <?php if(is_array($attributes) && count($attributes)): ?>
                            <a class="default-btn color-orange" href="<?php echo e(route('frontend.products.single', $item->slug)); ?>">
                                <i class="las la-shopping-cart icon"></i> __('Add to Cart')
                            </a>
                        <?php else: ?>
...
<!-- product countdown area end --><?php /**PATH C:\laragon\www\lvbeauty\@core\app\Providers/../PageBuilder/views/product/product_sale_style_two.blade.php ENDPATH**/ ?>