            ...
            <div class="col-lg-12">
                <div class="our-stor-isotop-btn-wrapper">
                    <ul class="our-stor-btn-list">
                        <li data-filter="new-items" class="product_filter_style_two active">Sản phẩm mới</li>
                        <li data-filter="top-rated" class="product_filter_style_two">Sản phẩm nổi bật</li>
                        <li data-filter="top-selling" class="product_filter_style_two">Sản phẩm bán chạy</li>

                        <li data-filter="discounted" class="product_filter_style_two">Ưu đãi</li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\lvbeauty\@core\app\Providers/../PageBuilder/views/product/product_filter_style_two.blade.php ENDPATH**/ ?>